...
class SleepTest {
  public static void main( String[] args ) {
    ...
    //   System.out.println( Sleep.parseSleepArgument( "46s8m" ) );
        System.out.println( JavaProgrammDurchKomdandozeileSchlaffenLegen.parseSleepArgument( "1h" ) );
    ...
    JavaProgrammDurchKomdandozeileSchlaffenLegen.main( new String[]{ "1s", "2s","3m" } );
    System.out.println( System.currentTimeMillis() / 1000 );
  }
}