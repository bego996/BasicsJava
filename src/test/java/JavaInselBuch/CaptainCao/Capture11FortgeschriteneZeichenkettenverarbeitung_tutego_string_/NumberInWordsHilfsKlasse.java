...
public class NumberInWordsHilfsKlasse {
    ...
    public static final String[] NUMBERS_FROM_ZERO_TO_THOUSAND = numberConverterForFinalVariable();
    ...
    private static String[] numberConverterForFinalVariable(){
        String[] numbersFromZeroToThousand = new String[1001];
        for (int i = 0; i < numbersFromZeroToThousand.length; i++) {
            numbersFromZeroToThousand[i] = NumberInWordsHilfsKlasse.convertNumberToWords(i);
        }
        return numbersFromZeroToThousand;
    }
